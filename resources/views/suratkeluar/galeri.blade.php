                                ...
                                <div class="small-box">
                                  <div class="inner">
                                        <a href="{{URL::to('/')}}/datasuratkeluar/{{$suratkeluar->filekeluar}}" data-toggle="lightbox" data-title="Perbesar Gambar">
                                            <center>
                                                <img src="{{URL::to('/')}}/datasuratkeluar/{{$suratkeluar->filekeluar}}" width="220" height="150" alt="File .doc, .docx, atau .pdf tidak dapat ditampilkan, Silahkan klik Lihat Detail File">
                                            </center>
                                        </a>
                                  </div>
