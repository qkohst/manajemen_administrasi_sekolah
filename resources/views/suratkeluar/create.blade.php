            ...
            {{csrf_field()}}
                <div class="row">
                        <div class="col-6">
                            ...
                            <input value="{{old('no_surat')}}" name="no_surat" type="text" class="form-control" id="nomorsurat" placeholder="Nomor Surat" required>
                            ...
                            <select name="kode" class="custom-select my-1 mr-sm-2 bg-light" id="inlineFormCustomSelectPref" required>
                                <option value="">-- Pilih Klasifikasi Surat --</option>
                                @foreach($data_klasifikasi as $klasifikasi)
                                    <option value="{{$klasifikasi->kode}}">{{$klasifikasi->nama}} ( {{$klasifikasi->kode}} )</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-6">
