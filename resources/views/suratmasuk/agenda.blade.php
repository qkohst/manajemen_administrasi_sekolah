...
<section class="content card" style="padding: 10px 10px 20px 20px  ">
    <div class="box">
        ...
        <form action="/suratmasuk/filter_agenda" method="POST" class="row input-daterange">
                ...
                <div class="col-md-4">
                    <a class="btn btn-success btn-sm my-1 mr-sm-1" href="{{route('suratmasuk.agenda')}}"
                        role="button"><i class="fas fa-sync-alt"></i> Refresh</a>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <a class="btn btn-primary btn-sm my-1 mr-sm-1 float-right" href="/suratmasuk/agendamasukcetak_pdf" target="_blank"
                    role="button"><i class="fas fa-print"></i> Cetak 1</a>
                <a class="btn btn-primary btn-sm my-1 mr-sm-1 float-right" href="{{route('suratmasuk.downloadexcel')}}"
                    role="button"><i class="fas fa-file-excel"></i> Download Excel</a>
            </div>

            <div class="row table-responsive">
                <div class="col-12">
                    <table class="table table-head-fixed" id='agenda'>
                        <thead>
                            <tr class="bg-light">
                                <th>No.</th>
                                <th>Isi Ringkas</th>
