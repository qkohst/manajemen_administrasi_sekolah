        ...
        <form action="/pesdik/tambah" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input value="{{old('nisn')}}" name="nisn" type="text" class="form-control" id="nisn" placeholder="NISN" required>
                ...
                <div class="col-6">
                    ...
                    <input value="{{old('tempat_lahir')}}" name="tempat_lahir" type="text" class="form-control" id="tempat_lahir" placeholder="Tempat Lahir" required>
