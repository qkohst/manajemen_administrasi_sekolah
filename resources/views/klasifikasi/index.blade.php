                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/klasifikasi/{{$klasifikasi->id}}/delete" class="btn btn-danger btn-sm my-1 mr-sm-1" onclick="return confirm('Hapus Data ?')"><i class="nav-icon fas fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                </tbody>
                            ...
                            <form action="/klasifikasi/tambah" method="POST">
                                {{csrf_field()}}
                                    <div class="row">
                                        ...
                                        <input name="nama" type="text" class="form-control bg-light" id="nama" placeholder="Nama Klasifikasi" required>
                                        <label for="kode">Kode</label>
                                        <input name="kode"type="text" class="form-control bg-light" id="kode" placeholder="Kode Klasifikasi" required>
                                        <label for="uraian">Uraian</label>
                                        <textarea name="uraian"class="form-control bg-light" id="uraian" rows="3" placeholder="Uraian Klasifikasi" required></textarea>
                                        </div>
                                    </div>
                                    <hr>
